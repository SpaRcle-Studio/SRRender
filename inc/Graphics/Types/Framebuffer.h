...
namespace SR_GTYPES_NS {
    ...
    public:
        ...
        static Ptr Create(const SR_UTILS_NS::Vector<ImageFormat>& colors, ImageFormat depth);
        static Ptr Create(const SR_UTILS_NS::Vector<ImageFormat>& colors, ImageFormat depth, const SR_MATH_NS::IVector2& size);
        static Ptr Create(const SR_UTILS_NS::Vector<ImageFormat>& colors, ImageFormat depth, const SR_MATH_NS::IVector2& size, uint8_t samples);
        static Ptr Create(const SR_UTILS_NS::Vector<ImageFormat>& colors, ImageFormat depth, const SR_MATH_NS::IVector2& size, uint8_t samples, uint32_t layersCount);
        static Ptr Create(const SR_UTILS_NS::Vector<ImageFormat>& colors, ImageFormat depth, const SR_MATH_NS::IVector2& size, uint8_t samples, uint32_t layersCount, ImageAspect depthAspect);
