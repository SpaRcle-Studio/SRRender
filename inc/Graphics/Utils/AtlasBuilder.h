...
namespace SR_GRAPH_NS {
    ...
    public:
        AtlasBuilder& operator=(const AtlasBuilder& other);
    ...
    public:
        AtlasCreationStrategy(const std::list<SR_GRAPH_NS::TextureData::Ptr>& sprites, uint32_t totalWidth, uint32_t totalHeight);

    public:
        AtlasPtr ChooseAndCreate();
