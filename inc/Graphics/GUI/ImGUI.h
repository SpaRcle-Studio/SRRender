...
namespace SR_GRAPH_GUI_NS {
    ...
    SR_DLL_EXPORT extern ImVec2 DrawTexture(const void* pDescriptor, const SR_MATH_NS::IVector2& size, SR_GRAPH_NS::PipelineType pipelineType, bool imposition);
    SR_DLL_EXPORT extern ImVec2 DrawTexture(const SR_GRAPH_NS::Pipeline* pPipeline, uint32_t textureId, const SR_MATH_NS::IVector2& size, bool imposition);
