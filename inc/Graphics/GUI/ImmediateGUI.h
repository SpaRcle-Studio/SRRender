...
namespace SR_GRAPH_GUI_NS {
    ...
    namespace Immediate {
        ...
        SR_GRAPHICS_DLL_API extern bool BeginChild(const char* str_id);
        SR_GRAPHICS_DLL_API extern bool BeginChild(const char* str_id, const SR_MATH_NS::FVector2& size);
        SR_GRAPHICS_DLL_API extern bool BeginChild(const char* str_id, const SR_MATH_NS::FVector2& size, bool border);
        SR_GRAPHICS_DLL_API extern bool BeginChild(const char* str_id, const SR_MATH_NS::FVector2& size, bool border, WindowFlags flags);
